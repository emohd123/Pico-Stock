...
function Selector({ token, items, prefill = null }) {
    ...
    const [contact1, setContact1] = useState(prefill?.contact1?.name || '');
    const [title1, setTitle1] = useState(prefill?.contact1?.title || '');
    const [phone1, setPhone1] = useState(prefill?.contact1?.phone || '');
    const [email1, setEmail1] = useState(prefill?.contact1?.email || '');
    const [contact2, setContact2] = useState(prefill?.contact2?.name || '');
    const [title2, setTitle2] = useState(prefill?.contact2?.title || '');
    const [phone2, setPhone2] = useState(prefill?.contact2?.phone || '');
    const [email2, setEmail2] = useState(prefill?.contact2?.email || '');
    const [heads, setHeads] = useState(prefill?.heads ? String(prefill.heads) : '');
