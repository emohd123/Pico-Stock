...
import { LANDMARK_STORIES } from '@/lib/landmarkStories';

export const viewport = { width:'device-width', initialScale:1, maximumScale:5, viewportFit:'cover', themeColor:'#002d27' };
...
export function generateMetadata({params}) {
  ...
  return {
    ...
    ...(story ? {
      ...
      keywords:[story.title.en,'Saudi Arabia','Bahrain International Airport','National Day'],
...
export default function LandmarkPage({params}) {
  ...
  if(story)return <LandmarkJourney story={story} />;
