...
# Official venue evidence assigns permanent building identity and adds source circle14482.
from venue_enhancements import apply_scene
scene=apply_scene(scene);objects=scene['objects'];zones=scene['zones']
