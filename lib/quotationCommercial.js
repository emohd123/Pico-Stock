...
export const DEFAULT_BRANDING_LOGO = '/branding/pico-logo.png';
export const FALLBACK_BRANDING_LOGO = '/branding/pico-logo-dark.svg';

export function normalizeBrandingLogoPath(value) {
    const logoPath = String(value || DEFAULT_BRANDING_LOGO).trim();
    if (!logoPath) return DEFAULT_BRANDING_LOGO;
...
export const QUOTATION_COMPANY_PROFILE = {
    logoPath: DEFAULT_BRANDING_LOGO,
