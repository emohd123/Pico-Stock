...
const COURSE_LABELS = { bunker: 'a bunker', green: 'a putting green', tee: 'a teeing ground', fairway: 'the fairway', driving_range: 'the practice ground', cartpath: 'a cart path' };
...
export function courseFeaturesUnder(scene, object) {
  if (!scene?.objects || !object || !['tent', 'stage'].includes(object.kind)) return [];
  const [width, , depth] = object.dimensions;
