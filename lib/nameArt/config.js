...
// `background` is the National Day artwork the poster screen rests on between guests.
// Guests choose their own backdrop per poster, so this setting now governs the idle screen only.
