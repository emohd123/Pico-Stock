...
export function inferProductType(product) {
    ...
    if (haystack.includes('meeting chair') || haystack.includes('office chair') || nameHaystack.includes('revolving chair') || nameHaystack.includes('swivel')) return 'Meeting / Office Chair';
