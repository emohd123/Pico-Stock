...
export const SHOP_CATEGORIES = [
    ...
    },
    {
        ...
        label: 'Accessories',
        title: 'Accessories',
        description: 'Table accessories, lamps, vases, bowls and cushions to dress the space.',
    },
];

export const HOME_STEPS = [
    { icon: '\u{1F4CB}', iconKey: 'browse', title: 'Browse', description: 'Explore our catalogue of furniture, screens, and graphics.' },
    { icon: '\u{1F6D2}', iconKey: 'cart', title: 'Order', description: 'Add items to your cart and submit your order with booth details.' },
    { icon: '\u{1F4E7}', iconKey: 'mail', title: 'Confirm', description: 'Receive confirmation email and our team will follow up.' },
    { icon: '\u{1F69A}', iconKey: 'truck', title: 'Deliver', description: 'We deliver, set up, and collect while you focus on your exhibition.' },
];
