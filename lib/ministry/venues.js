...
/**
 * The venues offered in the planner's picker — the canonical spellings above,
 * so choosing from the list can never introduce a new variant of a hotel that
 * is already in the season.
 */
export const KNOWN_VENUES = RULES.map((r) => r.name);
