...
export const PAYMENT_TERMS = [
    ...
    '100% payment within 30 days of event completion.',
];

export const APPROVAL_NOTICE =
    'Client to obtain Ministry of Finance & National Economy approval for any scope changes or additions before implementation.';
