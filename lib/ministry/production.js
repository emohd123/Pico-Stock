...
// Table-top name plates. Production needs the exact Arabic wording, so the six
// GCC states (official GCC order) plus the two standing role plates are offered
// as a checklist; anything else is typed in per meeting.
export const NAME_TAG_ITEM_NO = 26;
export const GCC_NAME_TAGS = [
    ...
    { ar: 'الأمانة العامة', en: 'General Secretariat' },
];
export const GCC_NAME_TAG_EN = Object.fromEntries(GCC_NAME_TAGS.map((t) => [t.ar, t.en]));
