/**
 * worker/brain.js — LLM-based deep document understanding.
 */

const { openaiClient } = require('./providers');
 ...
 */
async function analyzeWithBrain(text, filename, relativePath) {
...
`;
        ...
        logger.error(`Brain analysis failed for ${filename}: ${error.message}`);
        return null;
    }
}
