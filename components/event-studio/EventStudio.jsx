...
import { tentFootprint, localGroundPoint, worldGroundPoint, freeFloorSlot, occupantsOf, clampIntoFootprint, hostTentAt, courseFeaturesUnder } from '@/lib/eventStudioLayout';
...
export default function EventStudio() {
  ...
  const onCourse=useMemo(()=>scene?scene.objects.filter(o=>o.kind==='tent'&&courseFeaturesUnder(scene,o).length).length:0,[scene]);
